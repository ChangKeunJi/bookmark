  ...
  function serialize(name, val, options) {
    ...
    if (opt.domain) {
      if (!fieldContentRegExp.test(opt.domain)) {
        throw new TypeError("options domain is invalid");
      }
    ...
    if (opt.path) {
      if (!fieldContentRegExp.test(opt.path)) {
        throw new TypeError("options path is invalid");
      }
    ...
    function hasDocumentCookie() {
      ...
      return (
        (typeof document === "undefined" ? "undefined" : _typeof(document)) ===
          "object" && typeof document.cookie === "string"
      );
    }
      ...
      (function () {
        ...
        Cookies.prototype.getAll = function (options, parseOptions) {
          ...
          for (var name_1 in this.cookies) {
            result[name_1] = (0, utils.readCookie)(
              this.cookies[name_1],
              options
            );
          }
