!(function (e, t) {
  ...
  function o(e, t) {
    ...
    for (
      var o = {}, r = t || {}, n = e.split(l), i = r.decode || p, a = 0;
      a < n.length;
      a++
    ) {
      var s = n[a],
  ...
  function r(e, t, o) {
    ...
    if ("function" != typeof n)
      throw new TypeError("options encode is invalid");
    ...
    if (r.domain) {
      if (!c.test(r.domain)) throw new TypeError("options domain is invalid");
      a += "; Domain=" + r.domain;
    }
    if (r.path) {
      if (!c.test(r.path)) throw new TypeError("options path is invalid");
      a += "; Path=" + r.path;
    }
    if (r.expires) {
      if ("function" != typeof r.expires.toUTCString)
        throw new TypeError("options expires is invalid");
    ...
    if (
      ...
      switch (
        ...
        case "none":
          ...
          break;
        default:
          throw new TypeError("options sameSite is invalid");
      }
    }
    return a;
  }
  ...
  var f = { parse: o, serialize: r },
    y = t(function (e, t) {
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.hasDocumentCookie = function () {
          return (
            "object" ===
  ...
  var n = t(function (e, t) {
    ...
    function o(e, t) {
      ...
      (this.changeListeners = []),
        ...
        (this.cookies = (0, y.parseCookies)(e, t)),
        new Promise(function () {
          o.HAS_DOCUMENT_COOKIE = (0, y.hasDocumentCookie)();
        }).catch(function () {});
    }
    var r =
      ((o.prototype._updateBrowserValues = function (e) {
        this.HAS_DOCUMENT_COOKIE &&
          (this.cookies = n.parse(document.cookie, e));
      }),
      (o.prototype._emitChange = function (e) {
      ...
      (o.prototype.get = function (e, t, o) {
        return (
          void 0 === t && (t = {}),
          this._updateBrowserValues(o),
          (0, y.readCookie)(this.cookies[e], t)
        );
      }),
      (o.prototype.getAll = function (e, t) {
        void 0 === e && (e = {}), this._updateBrowserValues(t);
        var o = {};
        for (var r in this.cookies)
          o[r] = (0, y.readCookie)(this.cookies[r], e);
        return o;
      }),
      (o.prototype.set = function (e, t, o) {
        var r;
        "object" === s(t) && (t = JSON.stringify(t)),
          (this.cookies = i(i({}, this.cookies), (((r = {})[e] = t), r))),
          this.HAS_DOCUMENT_COOKIE && (document.cookie = n.serialize(e, t, o)),
          this._emitChange({ name: e, value: t, options: o });
      }),
      (o.prototype.remove = function (e, t) {
        ...
        (this.cookies = i({}, this.cookies)),
          ...
          this.HAS_DOCUMENT_COOKIE && (document.cookie = n.serialize(e, "", o)),
